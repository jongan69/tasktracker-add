...
class sevenDayMass extends React.PureComponent {
  state = {
    selectedLang: 0,
  };
  render() {
    return (
      ...
      <View style={styles.container}>
        <Text style={styles.title}>7 Day Mass Focused Workout: </Text>
        ...
        <View style={styles.item}>
          ...
          Day 7: Shoulders, Legs, & Abs
           ...
           <Text style={'color: white'}> Russian Twist: 2 Sets of 30 </Text> 
           <Text style={'color: white'}> Pushups: 50+ (Superset) </Text>  
           <FinishedButton workout={this.state.selectedWorkout} workoutType={"7DayMass"}/>
