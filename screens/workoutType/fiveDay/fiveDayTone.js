...
class fiveDayTone extends React.PureComponent {
  state = {
    selectedLang: 0,
  };
  render() {
    return (
      <View style={styles.container}>
        <Text style={styles.title}>5 Day Tone Focused Workout: </Text>
        ...
        <View style={styles.item}>
          ...
          Day 5: Legs and Abs
           ...
           <Text style={'color: white'}> BARBELL ROLLOUT: 50+ (Superset) </Text>
        <FinishedButton workout={this.state.selectedWorkout} workoutType={"5DayTone"}/>
